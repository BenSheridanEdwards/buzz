...
/// Playback side of voice notes: authenticated downloads, retry and cancel,
/// seek and speed, and the coordinator that arbitrates players. Capture lives
/// in `voice_note_recording_test.dart`.
void main() {
