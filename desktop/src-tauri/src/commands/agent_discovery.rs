...
pub async fn save_custom_harness(
    ...
    Ok(AcpRuntimeCatalogEntry {
        ...
        default_parallelism: crate::managed_agents::harness_default_parallelism(
            &definition.command,
        ),
    })
}
...
mod post_install_restart;
use post_install_restart::restart_setup_mode_agents_after_install;
